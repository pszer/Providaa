...
LightPropPrototype = Props:prototype{
	...
	{"light_depthmap", nil, nil, nil,          "light's depthbuffer for shadow mapping"},
	{"light_lightspace_matrix", nil, nil, nil, "matrix for moving points to the space for this light"},
	--{"light_proj_matrix", nil, nil, nil, "matrix for moving points to the space for this light"},
	--{"light_view_matrix", nil, nil, nil, "matrix for moving points to the space for this light"},
	--{"light_rot_matrix", nil, nil, nil, "matrix for moving points to the space for this light"},
